  ...
  <div className="flex-1 flex flex-col">
    ...
    <main className="flex-1 overflow-y-auto p-8 space-y-8 custom-scroll">
      {activeTab === "calendar" ? (
        <>
          ...
          <div className="grid grid-cols-7 gap-4">
            {calendarDays.map((day) => (
              <div
                key={day.dayNumber}
                className="bg-gray-900/70 border border-gray-800 rounded-xl p-3 flex flex-col shadow-md hover:shadow-lg transition backdrop-blur-sm"
              >
                <div className="flex justify-between items-center mb-2">
                  ...
                  {day.events.length === 0 ? (
                    ...
                    day.events.map((ev) => (
                      <div
                        key={ev._id}
                        onClick={() => handleViewEvent(ev)}
                        className={`border-l-4 rounded-md px-2 py-1 text-xs cursor-pointer bg-gray-800/70 hover:bg-gray-800/90 transition ${
                          ev.color === "blue"
                            ? "border-blue-500"
                            : ev.color === "red"
                            ? "border-red-500"
        ...
        <>
          <div className="bg-gray-900/70 border border-gray-800 rounded-xl shadow-md overflow-hidden backdrop-blur-sm">
            <table className="w-full text-sm text-left">
              <thead className="bg-gray-800 border-b border-gray-700 text-gray-400 uppercase text-xs tracking-wide">
                <tr>
                  <th className="py-3 px-6">Event</th>
                  <th className="py-3 px-6">Type</th>
                  <th className="py-3 px-6">Date</th>
      ...
      {/* Drawer */}
    <div
  className={`fixed top-0 right-0 h-full w-full sm:w-[400px] bg-gray-950/95 text-gray-200 shadow-2xl transform transition-transform duration-300 ease-in-out border-l border-gray-800 backdrop-blur-md z-50 ${
    drawerOpen ? "translate-x-0" : "translate-x-full"
  }`}
>
  {/* Header */}
  <div className="flex items-center justify-between border-b border-gray-800 px-6 py-4 bg-gradient-to-r from-indigo-900/30 via-gray-900/60 to-gray-950/70 backdrop-blur-md">
  ...
  >
    ...
    <div>
      ...
      <input
        ...
        onChange={handleChange}
        required
        className="mt-1 w-full bg-gray-900/70 border border-gray-800 rounded-md px-3 py-2 text-sm text-gray-200 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 outline-none placeholder-gray-500"
      />
    </div>
    ...
    <div className="grid grid-cols-2 gap-4">
      <div>
        ...
        <input
          ...
          value={newEvent.date}
          onChange={handleChange}
          className="mt-1 w-full bg-gray-900/70 border border-gray-800 rounded-md px-3 py-2 text-sm text-gray-200 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 outline-none"
        />
      </div>
      <div>
    ...
    <div className="flex justify-end gap-3 pt-6">
      ...
      <button
        type="submit"
        className="px-4 py-2 bg-indigo-600 hover:bg-indigo-700 text-white rounded-md text-sm font-medium shadow-md transition"
      >
        Save
      </button>
    </div>
  ...
  <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-[70] animate-fadeIn">
    <div className="bg-gray-900/90 border border-gray-800 rounded-2xl shadow-2xl w-full max-w-md p-8 relative text-gray-200 backdrop-blur-md">
      {/* Close Button */}
      <button
        onClick={() => setShowDeleteModal(false)}
      ...
      <div className="text-center">
        <div className="flex justify-center mb-4">
          <div className="p-3 bg-red-900/30 border border-red-800 rounded-full">
            <svg
        ...
        <div className="flex justify-center gap-3">
          ...
          <button
            onClick={handleDeleteEvent}
            className="px-4 py-2 bg-gradient-to-r from-red-600 to-rose-700 hover:from-red-700 hover:to-rose-800 text-white text-sm font-medium rounded-md shadow-md transition"
          >
            Delete
          </button>
        </div>
